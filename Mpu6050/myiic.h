...
#define I2C_SCLK_GPIO_Pin GPIO_PIN_3

#define I2C_SDA_GPIOx GPIOE
#define I2C_SDA_Pin_Num 2
...
#define SDA_IN()	{GPIOE_MODER_L&=0XFFFFFFCF;GPIOE_MODER_L|=(0<<(2*I2C_SDA_Pin_Num));}
#define SDA_OUT()	{GPIOE_MODER_L&=0XFFFFFFCF;GPIOE_MODER_L|=(1<<(2*I2C_SDA_Pin_Num));}
