...
#define I2C_SCLK_GPIO_Pin GPIO_PIN_12

#define I2C_SDA_GPIOx GPIOB
#define I2C_SDA_Pin_Num 13
#define I2C_SDA_GPIO_Pin GPIO_PIN_13
#define Get_I2C_Pin_Num (I2C_SDA_Pin_Num>7?I2C_SDA_Pin_Num-8:I2C_SDA_Pin_Num)

/* 寄存器操作 */
#define SDA_IN()	{GPIOB_MODER_H&=0X0F0FFFFF;GPIOB_MODER_H|=8<<(4*Get_I2C_Pin_Num);}
#define SDA_OUT()	{GPIOB_MODER_H&=0X0F0FFFFF;GPIOB_MODER_H|=3<<(4*Get_I2C_Pin_Num);}
